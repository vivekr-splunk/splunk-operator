...
// GroupVersionKindFor implements the Client interface's GroupVersionKindFor method.
func (m *MockClient) GroupVersionKindFor(obj runtime.Object) (schema.GroupVersionKind, error) {
	// Implement your mock logic here.
	// For example, you might return a default GroupVersionKind or some test data.
	return schema.GroupVersionKind{}, nil
}

// IsObjectNamespaced implements the Client interface's IsObjectNamespaced method.
func (m *MockClient) IsObjectNamespaced(obj runtime.Object) (bool, error) {
	// Implement your mock logic here.
	// You can return true/false and nil error, or simulate an error if needed.
	return true, nil // Modify as per your test requirements.
}
